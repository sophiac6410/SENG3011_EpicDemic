...
import { DarkButton, WhiteButton } from "../styles/Global";
  ...
  return (
      <div style={{backgroundColor: "white"}}>
        <div className="bg-sky" style={{height: '100vh'}}>
          <NavbarComp updateNum={1}></NavbarComp>
          <Row>
            <div id="header">
              ...
              <div className="mt-1 mb-5 d-flex">
                <DarkButton className="align-self-center me-5 pe-5 ps-5">
                  <Typography variant="bodyImportant">Find a destination</Typography>
                </DarkButton>
                <WhiteButton className="align-self-center ms-4 pe-5 ps-5">
